...
urlpatterns = [
    ...
    path('projects_page/<int:pk>/update/', ProjectUpdateView.as_view(), name='update_project'),
    path('projects_page/<int:pk>/delete/', ProjectDeleteView.as_view(), name='delete_project'),
    path('projects_page/<int:pk>/', ProjectDetailView.as_view(), name='projects_detail'),
    path('projects_page/', ProjectListView.as_view(), name='projects_page'),
    path('roles_page/<int:pk>/update/', RoleUpdateView.as_view(), name='update_role'),
    path('roles_page/<int:pk>/delete/', RoleDeleteView.as_view(), name='delete_role'),
